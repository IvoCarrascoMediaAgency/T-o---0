...
$('.eti5a').on('click', function(){
  $('.datos5a').addClass('show');
  $('.datos1a').removeClass('show');
  $('.datos3a').removeClass('show');
  $('.datos2a').removeClass('show');
  $('.datos4a').removeClass('show');
...
$('.eti1a').on('click', function(){
  ...
  $('.eti5a').removeClass('select tripimg');
...
// var myWindow = window.open ("https://api.whatsapp.com/send?phone=593998915543&text="+"Hola deseo más información de:" + "%20" + "*Páginas Web Ecommerce™ y Redes Sociales*" + "%0A"+"✅ _Registro confirmado_" + "%0A"+"_________________________" + "%0A"+"%0A"+ "*Nombre*" +"%0A" + nombre + "%20" +"%0A"+"%0A" +"*Nombre del Negocio*" +"%0A" + nombrenegocio +  "%20" + "%0A"+"%0A"+"*Tipo de Negocio*"+"%0A" + tipodenegocio + "%20"+ "%0A"+"%0A"+"*Día y hora para contacto*"+"%0A" +horaprueba+"%0A" + "%0A"+ "_________________________" + "%0A" + "%0A"+"*P.D.*"+ "%20"+ "Guarda nuestro contacto como *Páginas Web Ecommerce* para poder recibir toda la información 😉👍");


var whatsapp_number ="&text=✅ _Registro confirmado_"+ "%20" + "*PROAIRE*" + "%0A"+"_________________________" + "%0A"+"%0A"+ "👤 *Nombre*" +"%0A" + nombre + "%20" +"%0A"+"📩 *Correo*" +"%0A"+ mail + "%0A"+ "_________________________" + "%0A" +"Felicitaciones"+"%20"+nombre+"%20"+"un especialista se contactará de inmediato."+ "%0A"+ "_________________________"+ "%0A"+"*P.D.*"+ "%20"+ "Por favor guarda nuestro contacto para poder recibir toda la información 😉👍";
...
window.open(document.getElementById("boton1f").href = "https://api.whatsapp.com/send?phone=593998915543" + whatsapp_number);


} else {

window.open(document.getElementById("boton1f").href = "https://web.whatsapp.com/send?phone=593998915543" + whatsapp_number);
...
//     window.open(document.getElementById("enviarwa2").href = "https://api.whatsapp.com/send?phone=593998915543" + myWindow);

//   } else {
 
//     window.open(document.getElementById("enviarwa2").href = "https://web.whatsapp.com/send?phone=593998915543" + myWindow);
...
//     window.open(document.getElementById("enviarwaff").href = "https://api.whatsapp.com/send?phone=593998915543&text=Hola%20deseo%20más%20información%20de%20*Páginas%20Web%20Ecommerce™%20y%20Redes%20Sociales%0A%0A✅%20_Registro%20confirmado%0A%0A*P.D.*%20Guarda%20nuestro%20contacto%20como%20*Páginas%20Web%20Ecommerce*%20para%20poder%20recibir%20toda%20la%20información%20😉👍") ;

//   } else {
   
//     window.open(document.getElementById("enviarwaff").href = "https://web.whatsapp.com/send?phone=593998915543&text=Hola%20deseo%20más%20información%20de%20*Páginas%20Web%20Ecommerce™%20y%20Redes%20Sociales%0A%0A✅%20_Registro%20confirmado%0A%0A*P.D.*%20Guarda%20nuestro%20contacto%20como%20*Páginas%20Web%20Ecommerce*%20para%20poder%20recibir%20toda%20la%20información%20😉👍");
...
var whatsapp_number ="&text=✅ _Registro confirmado_"+ "%20" + "*PROAIRE*" + "%0A"+"_________________________" + "%0A"+"%0A"+ "👤 *Nombre*" +"%0A" + nombre + "%20" +"%0A"+"📩 *Correo*" +"%0A"+ mail + "%0A"+ "_________________________" + "%0A" +"Felicitaciones"+"%20"+nombre+"%20"+"un especialista se contactará de inmediato para atender tu consulta."+ "%0A"+ "_________________________"+ "%0A"+"*P.D.*"+ "%20"+ "Por favor guarda nuestro contacto para poder recibir toda la información 😉👍";
  ...
  if (md.mobile()) {
   ...
   window.open(document.getElementById("botonwa").href = "https://api.whatsapp.com/send?phone=593998915543" + whatsapp_number);
  
   
  } else {
  
    window.open(document.getElementById("botonwa").href = "https://web.whatsapp.com/send?phone=593998915543" + whatsapp_number);
...
var md = new MobileDetect(window.navigator.userAgent);
   if (md.mobile()) {
    ...
    window.open(document.getElementById("enviarwaff").href = "https://api.whatsapp.com/send?phone=593998915543&text=%20Hola,%20deseo%20m%C3%A1s%20informaci%C3%B3n") ;

  } else {
   
    window.open(document.getElementById("enviarwaff").href = "https://web.whatsapp.com/send?phone=593998915543&text=%20Hola,%20deseo%20m%C3%A1s%20informaci%C3%B3n");
