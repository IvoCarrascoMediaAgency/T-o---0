    ...
    'C2':{
       items:{
        ...
        'I1':{
          ...
          price:299,
          qty:0,
          img:'img24/aire-acondicionado-para-laboratorios.webp',
           linkpago:'https://payp.page.link/XHYo',
          },
          ...
          price:299,
          qty:0,
          img:'img24/Aire-acondicionado-para-oficina.webp',
           linkpago:'https://payp.page.link/XHYo',
          },
          'I6':{
          name:'Auditorios',
    ...
    'C3':{
      items:{
        ...
        'I1':{
          ...
          'I3':{
          name:'Extracción en cocinas',
          desc:'',
          price:130.00,
          qty:0,
          img:'img24/extracion-en-cocinas.webp',
           linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
          },
          
          'I4':{
          name:'Suministro de Aire Fresco',
          desc:'',
          price:130.00,
          qty:0,
          img:'img24/suministro-aire-fresco.webp',
           linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
  ...
  'C4':{
    items:{
      ...
      'I1':{
        ...
        'I2':{
        name:'Sistema Contra Incendios Edificios',
        desc:'',
        price:130.00,
        qty:0,
        img:'img24/sistemas-contraincendios2.webp',
         linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
        },
        
        'I3':{
        name:'Sistema Centralizado de Gas',
        desc:'',
        price:130.00,
        qty:0,
        img:'img24/sistema-centralizado-gas.webp',
         linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
        },
...
Object.entries(pedido_store.categories).forEach(([key,item],ind) => {
  ...
  menu_sec.classList.add("owl-theme");
...
var whatsapp_number ="&text=*Orden exitosa*" + "%0A"+"*PROAIRE*"+ "%0A"+"✅ *Detalle de la orden:*"+"%0A"+"_Orden N°_"+"%20"+ "%20"+"---"+"%20"+orden+"%20"+"---"+ "%0A"+"_________________________" + "%0A"+mostrarpedidof+ "%0A"+"*Total:*"+ "%20"+ "$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+ "%0A"+"_________________________"+ "%0A"+'*🙂Datos del Cliente:*'+ "%0A"+mostrarfac+"%20"+mostrarcedula+nombre+email+whatsapp+"%20"+"_________________________" +"%0A"+ retornapagos+cambio+"%0A"+fanlink+"%20"+"%0A"+"*Total:*"+ "%20"+"$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+"%0A"+"%0A"+"*Orden N°:*"+ "%20"+orden;
  ...
  //   }
  //  else{
    window.open(document.getElementById("enviarwa").href = "https://api.whatsapp.com/send?phone=593998915543" + whatsapp_number);
  //  }
     ...
     window.open(document.getElementById("enviarwa").href = "https://web.whatsapp.com/send?phone=593998915543" + whatsapp_number);
